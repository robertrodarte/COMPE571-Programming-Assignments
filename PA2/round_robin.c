...
int main(int argc, char const *argv[])
{
	...
	**************************************************************************/
	...
	running1 = running2 = running3 = running4 = 1;
	...
	while (running1 > 0 || running2 > 0 || running3 > 0 || running4 > 0)
	{
		if (running1 > 0)
		{
			...
			if (ret > 0)
			{
				...
				runtime1 = (end.tv_sec - start.tv_sec) +
		...
		if (running2 > 0)
		{
			...
			{
				clock_gettime(CLOCK_MONOTONIC, &end);
				runtime2 = (end.tv_sec - start.tv_sec) +
						   ((end.tv_nsec - start.tv_nsec) / 1E9);
				record_rt(runtime2);
				running2 = 0;
		...
		if (running3 > 0)
		{
			...
			{
				clock_gettime(CLOCK_MONOTONIC, &end);
				runtime3 = (end.tv_sec - start.tv_sec) +
						   ((end.tv_nsec - start.tv_nsec) / 1E9);
				record_rt(runtime3);
				running3 = 0;
		...
		if (running4 > 0)
		{
			...
			{
				clock_gettime(CLOCK_MONOTONIC, &end);
				runtime4 = (end.tv_sec - start.tv_sec) +
						   ((end.tv_nsec - start.tv_nsec) / 1E9);
				record_rt(runtime4);
				running4 = 0;
